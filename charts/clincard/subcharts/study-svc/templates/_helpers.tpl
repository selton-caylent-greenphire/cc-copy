...
Common labels
*/}}
{{- define "studysvc.labels" -}}
name: {{ include "studysvc.name" . }}
chart: {{ include "studysvc.chart" . }}
{{ include "studysvc.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "studysvc.selectorLabels" -}}
app: {{ template "studysvc.name" . }}
component: {{ template "studysvc.fullname" . }}
...
*/}}
{{- define "studysvc.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "studysvc.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "studysvc.rollingUpdateDeploymentStrategy" -}}
