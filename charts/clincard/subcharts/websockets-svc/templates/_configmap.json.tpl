{
    "gunicorn": {
        "bind": {{ default "0.0.0.0:5678" .gunicornBind | quote}},
        "workers": {{ default 3 .gunicornWorkers}},
        "threads": {{ default 1 .gunicornThreads}},
        "timeout": {{ default 30 .gunicornTimeout}},
        "preload_app": {{ default true .gunicornPreloadApp}},
        "worker_class": {{ default "sync" .gunicornWorkerClass | quote }},
        ...
        "log_level": {{ default "DEBUG" .gunicornLogLevel | quote }}
    },
    "logging": {
        ...
        "loggers": {
            ...
            "pika": {
                "level": {{ default "INFO" .loggerPikaLevel | quote}},
                "handlers": ["logstash"],
                "propagate": {{ default false .loggerServicePropagate }}
            },
            "websockets": {
                "level": {{ default "INFO" .loggerWebsocketsLevel | quote}},
                "handlers": ["logstash"],
                "propagate": {{ default false .loggerServicePropagate }}
            }
        },
