...
Common labels
*/}}
{{- define "milestonesvc.labels" -}}
name: {{ include "milestonesvc.name" . }}
chart: {{ include "milestonesvc.chart" . }}
{{ include "milestonesvc.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "milestonesvc.selectorLabels" -}}
app: {{ template "milestonesvc.name" . }}
component: {{ template "milestonesvc.fullname" . }}
...
*/}}
{{- define "milestonesvc.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "milestonesvc.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "milestonesvc.rollingUpdateDeploymentStrategy" -}}
