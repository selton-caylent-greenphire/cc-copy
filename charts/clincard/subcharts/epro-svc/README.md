...
Helm chart with the epro-svc definition
...
|-----|------|---------|-------------|
| nameOverride | string | `"epro-svc"` |  |
| fullnameOverride | string | `"epro-svc"` |  |
| secretpath | string | `"lower"` |  |
| tier | string | `"api"` |  |
| image | string | `"160116585046.dkr.ecr.us-east-1.amazonaws.com/clincard/epro-service:2.2.0"` |  |
...
| portaldb.username | string | `"eprosvc"` |  |
...
| volumes[0].configMap.name | string | `"epro-svc"` |  |
...
| configMapJson[0].loggerServiceName | string | `"eproservice"` |  |
