...
*/}}
{{- define "paymentgateway.name" -}}
{{- default .Chart.Name .Values.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}

{{- define "paymentgateway.consumer.name" -}}
...
*/}}
{{- define "paymentgateway.fullname" -}}
...
{{- define "paymentgateway.consumer.fullname" -}}
{{ template "paymentgateway.fullname" . }}-consumer
{{- end -}}

{{/*
Create chart name and version as used by the chart label.
*/}}
{{- define "paymentgateway.chart" -}}
...
Common labels
*/}}
{{- define "paymentgateway.labels" -}}
name: {{ include "paymentgateway.name" . }}
chart: {{ include "paymentgateway.chart" . }}
{{ include "paymentgateway.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- define "paymentgateway.consumer.labels" -}}
name: {{ include "paymentgateway.consumer.name" . }}
chart: {{ include "paymentgateway.consumer.chart" . }}
{{ include "paymentgateway.consumer.selectorLabels" . }}
{{- if .Chart.AppVersion }}
version: {{ .Chart.AppVersion | quote }}
{{- end }}
heritage: {{ .Release.Service }}
...
Selector labels
*/}}
{{- define "paymentgateway.selectorLabels" -}}
app: {{ template "paymentgateway.name" . }}
component: {{ template "paymentgateway.fullname" . }}
release: {{ .Release.Name }}
{{- end }}

{{- define "paymentgateway.consumer.selectorLabels" -}}
app: {{ template "paymentgateway.consumer.name" . }}
component: {{ template "paymentgateway.consumer.name" . }}
release: {{ .Release.Name }}
...
*/}}
{{- define "paymentgateway.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "paymentgateway.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "paymentgateway.rollingUpdateDeploymentStrategy" -}}
