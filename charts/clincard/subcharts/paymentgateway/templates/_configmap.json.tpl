{
    "gunicorn": {
        ...
        "limit_request_line": {{ default 0 .gunicornLimitRequestLine}},
        "limit_request_fields": {{ default 0 .gunicornLimitRequestFields}},
        "limit_request_field_size": {{ default 0 .gunicornLimitRequestFieldSize}},
    ...
    "logging": {
        ...
        "handlers": {
            ...
            "console": {
                ...
                "level": {{ default "DEBUG" .handlerConsoleLevel | quote}},
        ...
        "loggers": {
            {{ default "service" .loggerServiceName | quote}}: {
                "level": {{ default "INFO" .loggerServiceLevel | quote}},
                "handlers": ["logstash"],
                "propagate": {{ default false .loggerServicePropagate }}
            }
        },
        "root": {
            "level": {{ default "INFO" .loggerRootLevel | quote}},
            "handlers": ["logstash"]
        }
    }
}