...
Common labels
*/}}
{{- define "subjectsvc.labels" -}}
name: {{ include "subjectsvc.name" . }}
chart: {{ include "subjectsvc.chart" . }}
{{ include "subjectsvc.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "subjectsvc.selectorLabels" -}}
app: {{ template "subjectsvc.name" . }}
component: {{ template "subjectsvc.fullname" . }}
...
*/}}
{{- define "subjectsvc.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "subjectsvc.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "subjectsvc.rollingUpdateDeploymentStrategy" -}}
