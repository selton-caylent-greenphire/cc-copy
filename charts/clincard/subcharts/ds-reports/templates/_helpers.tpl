...
*/}}
{{- define "dsreports.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "dsreports.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
...
Common labels
*/}}
{{- define "dsreports.labels" -}}
name: {{ include "dsreports.name" . }}
chart: {{ include "dsreports.chart" . }}
{{- if .Chart.AppVersion }}
